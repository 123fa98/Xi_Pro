    ...
    Data = {
        ...
        KillSayStuff = {
            Normal = {
                ...
                "Google说'如何从公开羞辱中恢复'",
                "连机器人都有更好的反应时间, %Died%",
                "胡子男曾经说过: '胜利不属于缓慢或软弱的人, 而属于快速和勇敢的人.'",
                "爱因斯坦曾经写道: '技能是知识的应用, 而运气是无知的应用.'",
                "孙子曾经说过: '在战争中, 就像在战斗中一样, 犹豫不决的人注定要失败.'",
                "拿破仑曾经写道: '战场不是靠纯粹的力量赢得的, 而是靠技能和准备.'",
                "成吉思汗曾经宣称: '最大的胜利是敌人不知道自己被击败了.'",
                "胡子男宣称: '一个人不能简单地生存于战斗中, 而要在其中茁壮成长.'",
                "爱因斯坦曾经说过: '重要的不是你跑得多快, 而是你如何利用你的动力.'",

                "在 /Atomic 获取这个脚本!",
                "加入 /Atomic 成为屠龙者",
                "龙杀账号在 /Atomic 掉落!",
                "想要获得免费龙杀账号的机会, 去 /Atomic!",
                "厌倦了作弊者? 自己成为其中一个并与之战斗! /Atomic!",
            ...
            Assist = {
                "兄弟像Boss战一样被团队连击了",
                "你没死于我, 是死于团队合作",
                "和路人分享了 %XP% XP 和 %Credits% 积分, 感谢你的捐赠 %Died%",
                "お前は味方にやられた",
                "我得到了路人的帮助, 但我一个人就足以单挑你 %Died%",
                ...
                "4K高清被抓到被双人围攻",
                "兄弟被技能问题和助攻双重打击",
                "孙子曾经写道: '敌人永远不会被单独击败; 盟友的力量才是胜利的真正衡量标准.'",
                "拿破仑曾经说过: '将军只有和并肩作战的士兵一样优秀.'",
                "爱因斯坦曾经打趣道: '团队努力的胜利只是提醒我们团结克服个人缺陷.'",
                "成吉思汗的座右铭: '即使是最小的战士, 在合作时也能产生最大的影响.'",
                "胡子男说: '团队合作让梦想成真, 或者在这种情况下, 让击杀成真.'",
            },
            Finish = {
                "你的账号已被暂停, %Died%",
                "兄弟被 %Weapon% 送到了暗影领域",
                "%Died%, 应该闪避的, 哦等等... 太晚了 💀",
                "哟 %Died%, 你的Roblox生涯结束得比限量物品库存还快",
                "Ты уничтожен",
                "你的名字应该是'免费击杀', %Died%",
                "%Died% 死得如此之快, 以至于Roblox都卡了 💀",
                "お前の敗北は確定していた",
                "お前の人生はチェックメイト",
                "终结技.",
                "兄弟像YouTube教程假人一样出去了",
                "兄弟被煮熟, 油炸, 然后上菜了",
                "兄弟的网络提供商正式与他断绝关系了",
                "胡子男曾经说过: '最大的失败来自于拒绝接受自己的命运.'",
                "拿破仑曾经宣布: '战争在战场上之前就在心中赢得了.'",
                "孙子曾经写道: '战场不仅仅是一个地方, 它是一种心态.'",
                "成吉思汗曾经宣称: '当战士无法适应变化的潮流时, 他们的生命就结束了.'",
                "爱因斯坦曾经说过: '最终, 只有聪明的人才能生存.'",
            },
            Glory = {
                "你的死亡动画很美, %Died%",
                "有人录下那个, %Died% 刚刚被打包了",
                "%Died%, 想看我的后坐力脚本吗? (这叫技能)",
                "哟 %Died%, 你的游戏玩法看起来像速通到死亡画面",
                "兄弟的遗言: '我能行' 💀",
                ...
                "100% 卸载速通, 新纪录 %Died%",
                "兄弟以为他有机会, 但脚本说不行",
                "胡子男曾经说过: '胜利是给那些敢于毫不犹豫战斗的人的甜蜜滋味.'",
                "孙子曾经写道: '唯一真正的失败是没有战斗就遭受的失败.'",
                "爱因斯坦曾经说过: '重要的不是你跑得多快, 而是你如何利用你的动力.'",
                "成吉思汗曾经宣称: '战斗不是仅靠力量赢得的, 而是靠意志和智慧.'",
                "拿破仑说: '预测未来的最好方法就是创造它.'",
            }
        }
    }
...
-- // reworked hitsounds
local hitsoundsfolder = "Atomic/hitsounds"
...
applymorph = function()
    ...
    if Classes.MorphDropdown.Value == "无" then
...
local Teleports = {
    Crossroads = {
        Teleports = {
            ["黑山"] 		  = CFrame.new(-167, 91, 246),
            ["黑山 (背面)"] = CFrame.new(-187, 25, 319),
            ["棕山"] 		  = CFrame.new(143, 101, 251),
            ["棕山 (背面)"] = CFrame.new(147, 26, 326),
            ["绿山"] 		  = CFrame.new(159, 86, -131),
            ["绿山 (背面)"] = CFrame.new(273, 25, -207),

            ["前滩"] 		  = CFrame.new(-255, 28, -6),
            ["左滩"] 			  = CFrame.new(-46, 22, -231),
            ["右滩"] 		  = CFrame.new(-41, 25, 328),
            ["后滩"] 			  = CFrame.new(271, 23, 13),

            ["中心"] 				  = CFrame.new(0, 22, 0),
            ["灰塔"] 			  = CFrame.new(-48, 60, 55),
            ["蓝塔"] 		      = CFrame.new(-86, 67, -76),
            ["红塔"] 			  = CFrame.new(150, 69, 159),
            ["地下室"] 			  = CFrame.new(157, 26, -80),
            ["桥"]	 			  = CFrame.new(-174, 45, -47),
        },
        GetNames = function(self)
            local tb = {}
...
ReGui:DefineTheme("Monochrome", Data.Theme or {
	...
	CollapsingHeaderBg = Color3.fromRGB(0, 0, 0),
	CollapsingHeaderText = Color3.fromRGB(255, 255, 255),
	RadioButtonHoveredBg = Color3.fromRGB(0, 0, 0),
	
	WindowBg = Color3.fromRGB(0, 0, 0),
	TitleBarBg = Color3.fromRGB(0, 0, 0),
	TitleBarBgActive = Color3.fromRGB(0, 0, 0),
...
if Data.Intro then
    ...
    LoaderList:Image({
        Image = Data.UIIcon or 18374456807,
        Ratio = 1.25,
    ...
    LoaderProgress:SetValueText("Loading Atomic please wait...")
...
local CloseRange = CreateTab("近战", "rbxassetid://124159074947754", UDim2.new(0, 0, 1.175, 0))
local Ranged = CreateTab("远程", "rbxassetid://92157041036177", UDim2.new(0, 0, 1.05, 0))
local Character = CreateTab("角色", "rbxassetid://81489458260315", UDim2.new(0, 0, 1.075, 0))
local Visuals = CreateTab("视觉", "rbxassetid://7300480952", UDim2.new(0, 0, 0, 0))
local Misc = CreateTab("杂项", "rbxassetid://7734042071", UDim2.new(0, 0, 1.3, 0))
local Settings = CreateTab("设置", "rbxassetid://7300486042", UDim2.new(0, 0, 0, 0))

--SelectorObject.Body.CanvasSize = UDim2.new(0, 0, 1.175, 0)

--// Melee Tab
local CombatSection = CreateRegion(CloseRange, "击杀光环") do --// Kill Aura
    Create(CombatSection, "Checkbox", {Label = "击杀光环", Value = false}, "KillAura", "自动为你攻击敌人", true)
    Create(CombatSection, "Checkbox", {Label = "播放动画", Value = false}, "PlayAnimation", "在挥击时播放动画", true)
    Create(CombatSection, "Checkbox", {Label = "传送到敌人", Value = false}, "TPEnemy", "传送到敌人身边, 让你更难被击中", true)
    Create(CombatSection, "Checkbox", {Label = "使用武器冷却", Value = false}, "UseWeaponCD", "使用你的武器冷却时间或你自己指定的冷却时间", true)
    Create(CombatSection, "Combo", {Label = "击杀光环类型", Selected = 1, Items = {"单人", "多人"}}, "KillAuraType", "自解释... 我想?")

    Create(CombatSection, "SliderProgress", {Label = "范围", Value = 15, Minimum = 5, Maximum = 15, Format = "%.f 格"}, "KillAuraRange", "击杀光环的范围")
    Create(CombatSection, "SliderProgress", {Label = "冷却", Value = 0.35, Minimum = 0.35, Maximum = 1, Format = "%.2f 秒"}, "KillAuraCooldown", "如果关闭使用武器冷却, 击杀光环的冷却时间")
    Create(CombatSection, "Combo", {Label = "传送类型", Selected = 1, Items = {"背后", "环绕", "上方", "随机"}}, "TPType", "传送类型")
    Create(CombatSection, "SliderProgress", {Label = "传送范围", Value = 10, Minimum = 0, Maximum = 12, Format = "%.f 格"}, "TPRange", "传送到敌人的范围")
    
    Create(CombatSection, "Checkbox", {Label = "范围指示器", Value = false}, "RangeIndicator", "显示你的检测范围", true, true)
end

local Modifications = CreateRegion(CloseRange, "修改") do --// Modificationss
    Create(Modifications, "Checkbox", {Label = "总是命中", Value = false}, "AlwaysHit", "如果目标在你的范围内, 总是命中他们", true)
    Create(Modifications, "Combo", {Label = "命中部位", Selected = 1, Items = {"头部", "躯干"}}, "AlwaysHitPart", "要命中的部位")
    Create(Modifications, "SliderProgress", {Label = "范围", Value = 15, Minimum = 5, Maximum = 15, Format = "%.f 格"}, "AlwaysHitRange", "总是命中的范围")

    Modifications:Separator({Text = "其他"})

    Create(Modifications, "Checkbox", {Label = "反格挡", Value = false}, "AntiParry", "大部分时间防止你被格挡", true)
    Create(Modifications, "Checkbox", {Label = "自动装备", Value = false}, "AutoEquip", "自动装备你的武器", true)
    Create(Modifications, "Checkbox", {Label = "假挥击", Value = false}, "FakeSwing", "播放挥击动画来诱骗低级的自动格挡", true)
    Create(Modifications, "Checkbox", {Label = "播放挥击声音", Value = false}, "SwingSound", "播放挥击声音来诱骗不错的自动格挡", true, false, true)
    Create(Modifications, "Checkbox", {Label = "爆发挥击", Value = false}, "BurstSwing", "延迟你的第一次挥击以在短时间内造成大量伤害", true)
    Create(Modifications, "Checkbox", {Label = "降低挥击冷却", Value = false}, "LowerSwingCooldown", "降低你的挥击冷却时间", true)
    Create(Modifications, "SliderProgress", {Label = "降低", Value = 0.2, Minimum = 0, Maximum = 1, Format = "%.2f 秒"}, "LowerSwingValue", "降低多少秒")
...
CloseRange:Separator({Text = "格挡"})

local ParrySection = CreateRegion(CloseRange, "") do --// Auto Parry
    Create(ParrySection, "Checkbox", {Label = "自动格挡", Value = false}, "AutoParry", "自动格挡来袭的攻击", true)
    Create(ParrySection, "Checkbox", {Label = "幽灵检查", Value = false}, "GhostCheck", "检查玩家是否使用幽灵药水", true)
    Create(ParrySection, "Checkbox", {Label = "随机几率", Value = false}, "RandomChance", "随机化自动格挡几率", true)
    Create(ParrySection, "Checkbox", {Label = "检查是否看向", Value = false}, "LookCheck", "检查敌人是否在看着你", true)
    Create(ParrySection, "Combo", {Label = "检查方法", Selected = 1, Items = {"声音", "动画"}}, "APCheck", "要检查的内容")
    Create(ParrySection, "Combo", {Label = "自动格挡类型", Selected = 1, Items = {"狂暴", "合法"}}, "APType", "狂暴意味着没有动画, 合法播放动画, 显示盾牌")

    Create(ParrySection, "SliderProgress", {Label = "延迟", Value = 0, Minimum = 0, Maximum = 1, Format = "%.1f 秒"}, "APDelay", "格挡前等待多少秒")
    Create(ParrySection, "SliderProgress", {Label = "范围", Value = 15, Minimum = 1, Maximum = 15, Format = "%.f 格"}, "APRange", "检测敌人的距离")
    Create(ParrySection, "SliderProgress", {Label = "几率", Value = 100, Minimum = 1, Maximum = 100, Format = "%.f%%"}, "APChance", "格挡的几率")
    Create(ParrySection, "SliderProgress", {Label = "视角角度", Value = 45, Minimum = 1, Maximum = 180, Format = "%.f 度"}, "APAngle", "检查是否看向的角度")
    Create(ParrySection, "SliderProgress", {Label = "标记阈值", Value = 0.3, Minimum = 0, Maximum = 1, Format = "%.1f 秒"}, "Threshold", "动画的阈值")

    Create(ParrySection, "Checkbox", {Label = "范围指示器", Value = false}, "APRangIndicator", "显示你的格挡范围", true, true)
    Create(ParrySection, "Checkbox", {Label = "玩家视角角度指示器", Value = false}, "LookIndicator", "在敌人身上可视化视角角度", true, true)
end

--// Character Tab
local CharModifications = CreateRegion(Character, "角色修改") do --// Mods
    local First = false
    Create(CharModifications, "Checkbox", {Label = "移动速度", Value = false, Callback = function(self, bool)
    ...
    Create(CharModifications, "SliderProgress", {Label = "速度", Value = 30, Minimum = 16, Maximum = 30, Format = "%.f 格/秒"}, "WSValue", "你的自定义移动速度")

    Create(CharModifications, "Checkbox", {Label = "传送行走", Value = false}, "TPWalk", "带额外步骤的移动速度", true)
    Create(CharModifications, "SliderProgress", {Label = "速度", Value = 2, Minimum = 1, Maximum = 2, Format = "%.f 移速"}, "TPWalkValue", "传送行走速度")

    Create(CharModifications, "Checkbox", {Label = "跳跃力量", Value = false, Callback = function(self, bool)
        if not bool then
            if LocalPlayer.Character and LocalPlayer.Character:FindFirstChild("Humanoid") then 
    ...
    Create(CharModifications, "SliderProgress", {Label = "力量", Value = 50, Minimum = 50, Maximum = 1000, Format = "%.f 力量"}, "JPValue", "你的自定义跳跃力量")

    CharModifications:Separator({Text = "其他"})

    Create(CharModifications, "Checkbox", {Label = "飞行", Value = false}, "Fly", "能够飞行", true)
    Create(CharModifications, "Checkbox", {Label = "连跳", Value = false}, "Bhop", "自动为你跳跃", true)
    Create(CharModifications, "Checkbox", {Label = "旋转", Value = false}, "Spin", "你让我转圈, 宝贝, 转圈", true)
    Create(CharModifications, "Checkbox", {Label = "无动画", Value = false}, "NoAnimations", "停止任何播放的动画", true)
    Create(CharModifications, "Checkbox", {Label = "无限跳跃", Value = false}, "InfiniteJump", "能够在空中跳跃", true)
    Create(CharModifications, "SliderProgress", {Label = "飞行速度", Value = 30, Minimum = 1, Maximum = 30, Format = "%.f 格/秒"}, "FlySpeed", "飞行速度")
    Create(CharModifications, "SliderProgress", {Label = "旋转速度", Value = 100, Minimum = 1, Maximum = 100, Format = "%.f"}, "SpinSpeed", "旋转速度")

    CharModifications:Separator({Text = "复活"})

    Create(CharModifications, "Checkbox", {Label = "自动复活", Value = false}, "AR", "自动复活你", true)

    CharModifications:Separator({Text = "碰撞箱"})

    local parts = table.clone(R6BodyParts)
    table.insert(parts, '随机')
    Create(CharModifications, "Checkbox", {Label = "碰撞箱扩展", Value = false}, "HitboxExpand", "扩展玩家的碰撞箱", true, true, false, Color3.fromRGB(100, 83, 255))
    Create(CharModifications, "Checkbox", {Label = "显示扩展碰撞箱", Value = false}, "ShowHitbox", "显示扩展的碰撞箱", true)
    Create(CharModifications, "Combo", {Label = "命中部位", Selected = 1, Items = parts}, "HBEPart", "要命中的部位")
    Create(CharModifications, "SliderProgress", {Label = "碰撞箱大小", Value = 20, Minimum = 1, Maximum = 20, Format = "%.f 格"}, "HitboxSize", "碰撞箱大小")
...
local CharModifications2 = CreateRegion(Character, "角色修改 2") do --// Others
    Create(CharModifications2, "Checkbox", {Label = "无限体力", Value = false}, "IS", "永远不会耗尽体力", true)
    Create(CharModifications2, "Checkbox", {Label = "无限空气", Value = false, Callback = function(self, bool)
        if bool then
    ...
    end}, "IA", "永远不会耗尽空气", true)

    Create(CharModifications2, "Checkbox", {Label = "总是能跳跃", Value = false}, "CAJ", "即使被击倒也能跳跃", true)

    Create(CharModifications2, "Combo", {Label = "变形", Selected = None, Items = morphs, Callback = function() applymorph() end}, "MorphDropdown", "选择一个变形", false, false, false, Color3.fromRGB(87, 112, 255))

    Create(CharModifications2, "Checkbox", {Label = "无跳跃冷却", Value = false, Callback = function(self, bool)
        if bool then
    ...
    Create(CharModifications2, "Checkbox", {Label = "无冲刺冷却", Value = false, Callback = function(self, bool)
        if bool then
    ...
    Create(CharModifications2, "Checkbox", {Label = "无名称标签", Value = false}, "NT", "头顶不显示名称标签", true)
    Create(CharModifications2, "Checkbox", {Label = "无工具触发", Value = false}, "NUD", "禁用捕熊陷阱和地雷", true)
    Create(CharModifications2, "Checkbox", {Label = "即时使用工具", Value = false, Callback = function(self, bool)
        if bool then
    ...
    end}, "IUU", "禁用捕熊陷阱和地雷", true)
    Create(CharModifications2, "Checkbox", {Label = "无击退", Value = false}, "NKB", "禁用击退", true)
    Create(CharModifications2, "Checkbox", {Label = "无坠落伤害", Value = false, Callback = function(self, bool)
        Framework:GetSessionData():getState().fallDamageClient.isDisabled = bool
    end}, "NFD", "禁用坠落伤害", true)
    Create(CharModifications2, "Checkbox", {Label = "无布娃娃", Value = false}, "NR", "禁用布娃娃效果", true)
    Create(CharModifications2, "Checkbox", {Label = "无格挡眩晕", Value = false}, "NPS", "禁用格挡眩晕", true)
    Create(CharModifications2, "Checkbox", {Label = "无格挡减速", Value = false}, "NPS2", "禁用格挡时的减速", true)
    if Remotes then
        Create(CharModifications2, "Checkbox", {Label = "无闪光效果", Value = false}, "NoFlash", "禁用所有闪光弹/炸弹效果", true)
    else
        Create(CharModifications2, "Label", {Text = "由于你的执行器, 此功能已被禁用"})
    end
    Create(CharModifications2, "Checkbox", {Label = "无低血量效果", Value = false}, "NoHealth", "禁用低血量效果", true)
    Create(CharModifications2, "Checkbox", {Label = "无幽灵药水效果", Value = false}, "NoGhostPotEffect", "禁用幽灵药水效果", true)
    Create(CharModifications2, "Checkbox", {Label = "水上行走", Value = false, Callback = function(self, bool)
        for i, v in Map:GetDescendants() do
            if v:IsA("BasePart") and v.Name == "WaterArea" then
                v.CanCollide = bool
            end
        end
    end}, "WOW", "能够在水面上行走", true)

    CharModifications2:Separator({Text = "其他"})

    Create(CharModifications2, "Checkbox", {Label = "不同步", Value = false}, "Desync", "如果你想干扰静默瞄准计算, 请开启此选项", true)
    ...
    Create(CharModifications2, "Checkbox", {Label = "传送到死亡位置", Value = false}, "DTP", "传送到你最后死亡的位置", true)
    Create(CharModifications2, "Checkbox", {Label = "躲避投射物", Value = false}, "AvoidProjectiles", "传送你远离任何箭矢", true)
    Create(CharModifications2, "Checkbox", {Label = "隐藏背后武器", Value = false, Callback = function(self, bool)
        if bool then
            local Character = LocalPlayer.Character
            local Humanoid = Character and Character:FindFirstChildOfClass("Humanoid")
            if Humanoid then
    ...
    end}, "HideWeaponOnBack", "禁用背后的武器", true)
    ...
    }, "AntiHead", "在服务器上移除你的头部", true)

    Create(CharModifications2, "Button", {Text = "上帝模式", Callback = function()
...
--// Ranged Tab
local AimbotSection = CreateRegion(Ranged, "自瞄") do --// Aimbot
    Create(AimbotSection, "Checkbox", {Label = "自瞄", Value = false}, "Aimbot", "自动为你瞄准", true, false, true)
    Create(AimbotSection, "Checkbox", {Label = "平滑", Value = false}, "Smooth", "平滑相机", true, false)
    Create(AimbotSection, "Checkbox", {Label = "预测", Value = false}, "Prediction", "是否预测目标的下一个位置", true)
    Create(AimbotSection, "Checkbox", {Label = "按住按键", Value = false}, "Hold", "是否按住按键来激活", true)
    Create(AimbotSection, "Checkbox", {Label = "显示视野", Value = false}, "ShowFOVAimbot", "显示自瞄的视野", true, true)
    Create(AimbotSection, "Checkbox", {Label = "显示目标", Value = false, Callback = function(self, bool)
        if not bool then
            AimbotHighlight.Adornee = nil
            ShowInformation(nil)
        end
    end}, "ShowTargetAB", "显示自瞄目标", true, true)
    Create(AimbotSection, "SliderProgress", {Label = "视野大小", Value = 500, Minimum = 10, Maximum = 500, Format = "%.f"}, "FOVSizeAimbot", "改变视野的大小")
    Create(AimbotSection, "Combo", {Label = "命中部位", Selected = 1, Items = {"头部", "躯干"}}, "AimbotHitPart", "要瞄准和命中的部位")
end
local SilentAimSection = CreateRegion(Ranged, "静默瞄准") do --// Silent Aim
    Create(SilentAimSection, "Checkbox", {Label = "静默瞄准", Value = false}, "SilentAim", "操纵箭矢总是命中", true)
    Create(SilentAimSection, "Checkbox", {Label = "显示视野", Value = false}, "ShowFOV", "显示静默瞄准的视野", true, true)
    Create(SilentAimSection, "SliderProgress", {Label = "视野大小", Value = 500, Minimum = 10, Maximum = 500, Format = "%.f"}, "FOVSize", "改变视野的大小")
    Create(SilentAimSection, "Checkbox", {Label = "解析器", Value = false}, "Resolver", "解析目标并获取他们的真实位置", true)
    Create(SilentAimSection, "Checkbox", {Label = "显示目标", Value = false, Callback = function(self, bool)
        if not bool then
            SilentAimHighlight.Adornee = nil
            ShowInformation(nil)
        end
    end}, "ShowTargetSA", "显示静默瞄准目标", true, true)
    Create(SilentAimSection, "Combo", {Label = "检查类型", Selected = 1, Items = {"最近鼠标", "最近箭矢", "仅重定向到目标"}}, "ClosestType", "说明性")
    Create(SilentAimSection, "Combo", {Label = "命中部位", Selected = 1, Items = {"头部", "躯干", "随机"}}, "SilentHitPart", "要瞄准和命中的部位")
    Create(SilentAimSection, "SliderProgress", {Label = "命中几率", Value = 100, Minimum = 1, Maximum = 100, Format = "%.f%%"}, "HitChance", "命中的几率")
    Create(SilentAimSection, "SliderProgress", {Label = "范围", Value = 19, Minimum = 1, Maximum = 19, Format = "%.f 格"}, "SilentAimRange", "检测距离")
end
Ranged:Separator({Text = "修改"})
local ModificationsSection = CreateRegion(Ranged, "") do --// Mods
    Create(ModificationsSection, "Checkbox", {Label = "无扩散", Value = false, Callback = function(_, bool)
        if bool then
    ...
    end}, "NoSpread", "无投射物扩散", true)
    Create(ModificationsSection, "Checkbox", {Label = "无后坐力", Value = false, Callback = function(_, bool)
        if bool then
            modifyRanged("recoilAmount",0)
        else
            revertRanged("recoilAmount")
        end
    end}, "NoRecoil", "无投射物后坐力", true)
    Create(ModificationsSection, "Checkbox", {Label = "无重力", Value = false, Callback = function(_, bool)
        if bool then
            modifyRanged("gravity",Vector3.new(0,0,0))
        else
            revertRanged("gravity")
        end
    end}, "NoGravity", "无投射物重力", true)
    Create(ModificationsSection, "Checkbox", {Label = "无重载取消", Value = false}, "NoReloadCancel", "无远程重载取消", true)
    Create(ModificationsSection, "Checkbox", {Label = "无重载减速", Value = false, Callback = function(_, bool)
        if bool then
            modifyRanged("reloadWalkSpeedMultiplier",1)
        else
            revertRanged("reloadWalkSpeedMultiplier")
        end
    end}, "NoReloadSlow", "重载时无减速", true)
    Create(ModificationsSection, "Checkbox", {Label = "即时充能", Value = false, Callback = function(_, bool)
        if bool then
    ...
    end}, "InstantCharge", "无充能时间", true)
    Create(ModificationsSection, "Checkbox", {Label = "无限射程", Value = false, Callback = function(_, bool)
        if bool then
            modifyRanged("maxDistance", 10000)
        else
            revertRanged("maxDistance")
        end
    end}, "InfiniteRange", "非常公平地射击", true)
    Create(ModificationsSection, "Checkbox", {Label = "穿墙", Value = false}, "Wallbang", "忽略墙壁, 只命中玩家", true)
    Create(ModificationsSection, "Checkbox", {Label = "总是头部", Value = false}, "AlwaysHead", "即使命中其他部位也总是命中头部", true)
    Create(ModificationsSection, "Combo", {Label = "命中效果", Selected = 1, Items = {"无", "黑洞", "泡泡", "火焰", "发光", "地面螺旋", "冲击", "KO", "MLG", "冲击泡泡", "冲击波", "冲击波爆炸", "斩击", "灵魂斩击", "火花", "火花", "螺旋", "螺旋斩击", "闪光", "召唤", "超新星", "龙卷风", "Zzz"}}, "HitEffect", "当箭矢落地时, 显示效果", false, true, false, Color3.fromRGB(87, 112, 255))
end

--// Visuals Tab
local ESPSection = CreateRegion(Visuals, "ESP") do
    Create(ESPSection, "Checkbox", {Label = "启用", Value = false}, "ESP", "显示敌人位置", true)
    Create(ESPSection, "SliderProgress", {Label = "最大距离", Value = 5000, Minimum = 250, Maximum = 5000, Format = "%.f 格"}, "ESPMaxDistance", "ESP的距离有多远")
    ESPSection:Separator({Text = "配置"})
    Create(ESPSection, "Checkbox", {Label = "方框", Value = false}, "Boxes", "以方框显示敌人位置", true, true)
    Create(ESPSection, "Checkbox", {Label = "名称", Value = false}, "Names", "显示敌人名称", true, true)
    Create(ESPSection, "Checkbox", {Label = "血量", Value = false}, "Health", "显示敌人血量", true, true, false, Color3.fromRGB(0, 255, 0))
    Create(ESPSection, "Checkbox", {Label = "指示器", Value = false}, "Indicators", "显示指示器", true, true)
    Create(ESPSection, "Checkbox", {Label = "挥击冷却", Value = false}, "SwingCooldown", "显示挥击冷却", true, true)
    Create(ESPSection, "Checkbox", {Label = "格挡冷却", Value = false}, "ParryCooldown", "显示格挡冷却", true, true)
    Create(ESPSection, "Combo", {Label = "指示器类型", Selected = 1, Items = {"无", "工具", "距离", "两者"}}, "ESPTypes", "指示器类型")
    ESPSection:Separator({Text = "视野外"})
    Create(ESPSection, "Checkbox", {Label = "启用", Value = false}, "OutOfFOV", "显示视野外的敌人", true, true)
    Create(ESPSection, "SliderProgress", {Label = "大小", Value = 15, Minimum = 10, Maximum = 15, Format = "%.f"}, "OutFOVSize", "指示器的大小")
    Create(ESPSection, "SliderProgress", {Label = "偏移", Value = 400, Minimum = 100, Maximum = 700, Format = "%.f"}, "OutFOVOffset", "指示器的偏移")
    Create(ESPSection, "Combo", {Label = "设置", Selected = 1, Items = {"无", "轮廓", "闪烁", "两者"}}, "OFFSettings", "指示器类型")
    ESPSection:Separator({Text = "工具ESP"})
    Create(ESPSection, "Checkbox", {Label = "启用", Value = false}, "UtilityESP", "显示工具位置", true)
    Create(ESPSection, "SliderProgress", {Label = "最大距离", Value = 5000, Minimum = 250, Maximum = 5000, Format = "%.f 格"}, "UtilityESPMaxDistance", "ESP的距离有多远")
    ESPSection:Separator({Text = "配置"})
    Create(ESPSection, "Checkbox", {Label = "C4", Value = false}, "C4", "显示C4", true, true)
    Create(ESPSection, "Checkbox", {Label = "手榴弹", Value = false}, "Grenade", "显示手榴弹", true, true)
    Create(ESPSection, "Checkbox", {Label = "地雷", Value = false}, "Claymore", "显示地雷", true, true)
    Create(ESPSection, "Checkbox", {Label = "捕熊陷阱", Value = false}, "Beartrap", "显示捕熊陷阱", true, true)
        ...
        for _, Player in pairs(Players:GetPlayers()) do
            ...
            if not OnScreen then
                ...
                if not OnScreen then
                    ...
                    Drawing.Filled = not ((OFFSettings == "轮廓" or OFFSettings == "两者") or false)
                    Drawing.Transparency = ((OFFSettings == "闪烁" or OFFSettings == "两者") or false)
                ...
                if Classes.Indicators.Value then
                    ...
                    if ESPType == "工具" or ESPType == "两者" then
                        Tool.Text = (Character:FindFirstChildOfClass("Tool") and Character:FindFirstChildOfClass("Tool").Name) or "无"
                    ...
                    if ESPType == "距离" or ESPType == "两者" then
...
local LightingSection = CreateRegion(Visuals, "光照") do
    ...
    Create(LightingSection, "Checkbox", {Label = "世界环境光", Value = false}, "Ambience", "改变环境光", true, true)
    Create(LightingSection, "Checkbox", {Label = "颜色校正", Value = false}, "ColorCorrection", "改变颜色校正", true, true)
    Create(LightingSection, "Combo", {Label = "天空盒", Selected = 1, Items = {"无", "星云","蒸汽波","云朵","暮光"}}, "Skybox", "改变天空盒")
    Create(LightingSection, "Checkbox", {Label = "时钟时间", Value = false}, "ClockTime", "改变时钟时间", true)
    Create(LightingSection, "Checkbox", {Label = "最大缩放", Value = false}, "MaxZoom", "改变最大缩放", true)
    Create(LightingSection, "Checkbox", {Label = "视野", Value = false, Callback = function(_, bool)
        if not bool then
            Camera.FieldOfView = 70
        end
    end}, "FieldOfView", "改变视野", true)
    Create(LightingSection, "Checkbox", {Label = "亮度", Value = false}, "Brightness", "改变亮度", true)
    Create(LightingSection, "Checkbox", {Label = "环境效果", Value = false}, "Environmental", "改变环境效果", true)
    Create(LightingSection, "Checkbox", {Label = "曝光补偿", Value = false}, "Exposure", "改变曝光效果", true)
    Create(LightingSection, "SliderProgress", {Label = "时间", Value = 12, Minimum = 1, Maximum = 24, Format = "%.f"}, "Time", "时钟时间的时间")
    Create(LightingSection, "SliderProgress", {Label = "视野值", Value = 70, Minimum = 1, Maximum = 120, Format = "%.f"}, "FOVLighting", "你的视野")
    Create(LightingSection, "SliderProgress", {Label = "亮度", Value = 2, Minimum = 1, Maximum = 10, Format = "%.f"}, "BrightnessValue", "你想要的亮度")
    Create(LightingSection, "SliderProgress", {Label = "曝光", Value = 0, Minimum = 0, Maximum = 10, Format = "%.f"}, "ExposureValue", "曝光比例")
    Create(LightingSection, "SliderProgress", {Label = "漫反射 % 镜面反射", Value = 1, Minimum = 0, Maximum = 1, Format = "%.1f"}, "EnvironmentValue", "效果比例")
    Create(LightingSection, "SliderProgress", {Label = "最大缩放值", Value = 24, Minimum = 1, Maximum = 1000, Format = "%.f 格"}, "MaxZoomVal", "你想要缩放到多远")

    LightingSection:Separator({Text = "雾"})

    Create(LightingSection, "Checkbox", {Label = "雾", Value = false}, "Fog", "启用雾", true, true)
    Create(LightingSection, "SliderProgress", {Label = "密度", Value = 1, Minimum = 0, Maximum = 1, Format = "%.2f"}, "Density", "雾的密度")
    Create(LightingSection, "SliderProgress", {Label = "眩光", Value = 0, Minimum = 0, Maximum = 10, Format = "%.f"}, "Glare", "雾的眩光")
    Create(LightingSection, "SliderProgress", {Label = "薄雾", Value = 0, Minimum = 0, Maximum = 10, Format = "%.f"}, "Haze", "雾的薄雾")
...
--// More Visuals
Visuals:Separator({Text = "更多视觉"})
local MoreVisuals = CreateRegion(Visuals, "") do
    Create(MoreVisuals, "Checkbox", {Label = "伤害指示器"}, "DamageIndicator", "显示你造成的伤害, 就像\"捕食者\"部队一样", false, true, false)
end

--// Misc
local Section = CreateRegion(Misc, "主要") do
    local CratesReversed = {
        skinsCase = "皮肤",
        enchantsCase = "附魔",
        killEffectsCase = "击杀效果",
        case4 = "捆绑包",
        case5 = "角色光环",
        case6 = "格挡盾牌",
        case7 = "表情",
    ...
    Create(Section, "Checkbox", {Label = "击杀发言", Value = false}, "Killsay", "引起烦恼, 让人们试图和你说话时感到困惑", true)
    Create(Section, "Checkbox", {Label = "狂暴机器人", Value = false}, "Ragebot", "自动为你射击和重载", true)
    Create(Section, "Checkbox", {Label = "显示目标", Value = false, Callback = function(self, bool)
        if not bool then
            RagebotHighlight.Adornee = nil
            ShowInformation(nil)
        end
    end}, "ShowRageBotTarget", "显示狂暴机器人的目标", true)
    Create(Section, "Checkbox", {Label = "可视化箭矢线条", Value = false}, "ShowLine", "显示线条", true, true)
    Create(Section, "Checkbox", {Label = "可视化箭矢轨迹", Value = false}, "ShowArrow", "显示箭矢路径", true)
    Create(Section, "Combo", {Label = "狂暴机器人优先级", Selected = 1, Items = {"距离", "血量"}}, "RagebotPriority", "狂暴机器人的优先级")
    Create(Section, "SliderProgress", {Label = "狂暴机器人距离", Value = 1000, Minimum = 150, Maximum = 1000, Format = "%.f 格"}, "RagebotDist", "检测玩家的距离")
    Section:Separator({Text = "自动"})
    Create(Section, "Checkbox", {Label = "路径寻找", Value = false}, "Pathfind", "寻找路径到玩家 (启用击杀光环)", true)
    Create(Section, "Checkbox", {Label = "快速重生", Value = false}, "FastRespawn", "更快重生", true)
    Create(Section, "Checkbox", {Label = "循环重生", Value = false}, "LoopSpawn", "自动重生你", true)
    Create(Section, "SliderProgress", {Label = "路径寻找速度", Value = 34, Minimum = 1, Maximum = 34, Format = "%.f 格/秒"}, "PFSpeed", "路径寻找模式下的行走速度")
    Section:Separator({Text = "空投"})
    Create(Section, "Checkbox", {Label = "自动空投领取", Value = false}, "ClaimAirdrop", "自动领取空投", true)
    Section:Separator({Text = "传送"})
    Create(Section, "Combo", {Label = "地点", Selected = 1, Items = Teleports.Crossroads:GetNames()}, "CRTeleports", "在十字路口要传送到的地方")
    Create(Section, "Button", {Text = "传送到选定位置", Callback = function()
        Framework:Teleport(Teleports.Crossroads.Teleports[Classes.CRTeleports.Value])
    end}, "TTS", "传送到选定位置 (十字路口)")
    Section:Separator({Text = "装饰"})
    Create(Section, "Button", {Text = "获取猫", Callback = function()
        Network:FireServer("ExecuteCommand","getCat",{})
    end}, "GetCat", "获取一只...... 猫!")
    Create(Section, "Button", {Text = "解锁所有表情", Callback = function()
    ...
    Create(Section, "Checkbox", {Label = "挤压别人的猫", Value = false}, "SqueezeCat", "挤压别人的猫", true)
    Create(Section, "Checkbox", {Label = "反作弊时恢复网络", Value = false}, "Network", "当你被反作弊时尝试恢复网络", true)

    Section:Separator({Text = "箱子"})

    Create(Section, "InputText", {Label = "箱子ID", Placeholder = "在discord中查找ID"}, "CaseId", "要打开的箱子")
    Create(Section, "SliderProgress", {Label = "打开数量", Value = 10, Minimum = 1, Maximum = 10, Format = "%.f 次"}, "CaseAmount", "要打开多少个箱子")
    Create(Section, "Button", {Text = "打开箱子", Callback = function()
        local Found = false
        ...
        if Found then
            ...
            if Success then
                setthreadidentity(2)
                Modules.Name["ToastNotificationActionsClient"].add("success", `打开了 {tostring(Classes.CaseAmount.Value)} 个 {CratesReversed[Classes.CaseId.Value]} 箱子`, 2)(Modules.Name["RoduxStore"].store)
            ...
            TextChatService.OnIncomingMessage = function(obj)
                ...
                if source and Classes.StreamerMode.Value and Classes.HidePlayerNames.Value then
                    ...
                    if source.UserId ~= LocalPlayer.UserId then
                        ...
                        iboughtaproperty.PrefixText = "<font color=\"rgb(100, 83, 255)\">Atomic:</font>"
                    end
                end
                setthreadidentity(8)
...
do
    if not isfolder("Atomic/settings/") then
        makefolder("Atomic/settings/")
    end

    if not isfolder("Atomic/themes/") then
        makefolder("Atomic/themes/")
    end

    function GetConfigs()
        local list = listfiles('Atomic/settings')
    ...
    function GetThemes()
        local list = listfiles('Atomic/themes')
    ...
    function Save(name)
        ...
        local filename = "Atomic/settings/"..name..".json"
        DbgWarn(filename)
    ...
    function SaveTheme(name)
        ...
        if Theme then
            ...
            local filename = "Atomic/themes/"..name..".json"
            DbgWarn(filename)
    ...
    function Load(name)
        if name == "" then return end
        if not isfile("Atomic/settings/"..name..".json") then return end

        local Decoded = HttpService:JSONDecode(readfile("Atomic/settings/"..name..".json"))
        if Decoded then
    ...
    function LoadTheme(name)
        ...
        if not isfile("Atomic/themes/"..name..".json") then return end

        local Decoded = HttpService:JSONDecode(readfile("Atomic/themes/"..name..".json"))
        if Decoded then
    ...
    if isfile("Atomic/autoload.txt") then
        Load(readfile("Atomic/autoload.txt"))
    end

    if isfile("Atomic/autoloadtheme.txt") then
        LoadTheme(readfile("Atomic/autoloadtheme.txt"))
    end
    ...
    Create(OptionsSection, "Checkbox", {Label = "按键绑定列表", Value = false, Callback = function(self, bool)
        KeybindList:SetVisible(bool)
    end}, "KeybindList", "显示按键绑定列表")

    --if executor ~= "Velocity" then
        Create(OptionsSection, "InputText", {Label = "", Placeholder = "自定义击杀信息名称", Value = ""}, "CustomKillfeedName", "你的自定义击杀信息名称", false, true)
        Create(OptionsSection, "Checkbox", {Label = "直播模式", Value = false}, "StreamerMode", "隐藏你的信息", true)
        Create(OptionsSection, "Checkbox", {Label = "隐藏玩家名称", Value = false}, "HidePlayerNames", "隐藏玩家名称", true)
        Create(OptionsSection, "Checkbox", {Label = "隐藏外观", Value = false, Callback = function(_, State)
            if State then
    ...
    OptionsSection:Label({Text = "致谢:", Bold = true})
    OptionsSection:Label({Text = "Atomic -"})
    ...
    ConfigRow:Button({
        Text = "删除",
        Callback = function()
            local file = "Atomic/settings/"..ConfigCombo.Value..".json"
            if isfile(file) then
                delfile(file)
            end
        end
    ...
    ConfigRow:Button({
        ...
        Callback = function()
            local file = "Atomic/settings/"..ConfigCombo.Value..".json"
            if isfile(file) then
                writefile("Atomic/autoload.txt", file)
            end
        end
    })

    ConfigSection:Separator({Text = "主题"})
    ...
    ThemeRow:Button({
        Text = "删除",
        Callback = function()
            local file = "Atomic/themes/"..ThemeCombo.Value..".json"
            if isfile(file) then
                delfile(file)
            end
        end
    ...
    ThemeRow:Button({
        Text = "自动加载",
        Callback = function()
            local file = "Atomic/themes/"..ConfigCombo.Value..".json"
            if isfile(file) then
                writefile("Atomic/autoloadtheme.txt", file)
            end
        end
    })
                                ...
                                for playerName, health in closest do
                                    ...
                                    if targetPlayer and targetPlayer.Character and targetPlayer.Character:FindFirstChild("Head") and health ~= 0 and Framework:Check(targetPlayer.Character) then
                                        ...
                                        if session and not session:getState().parry.isParrying then
                                            ...
                                            if Classes.KillAuraType.Value == "单人" then
                                                break
                                            end
                                        end
                                    end
...
do -- Silent Aim
    ...
    function newSimulate(...)
        ...
        if (Classes.SilentAim.Value or Classes.Ragebot.Value) and weapon and metadata and not table.find(chanceCache, caster) and Chance and caster and caster.UserData and caster.StateInfo and caster.UserData.tool == weapon then
            ...
            if Classes.ClosestType.Value == "仅重定向到目标" then
                Player = nil
            ...
            if Classes.SilentAim.Value then
                if Classes.ClosestType.Value == "最近鼠标" then
                    if MouseClosest then
                        local PlayerChar = MouseClosest.Character
                        if PlayerChar then
                            local HitPart = PlayerChar:FindFirstChild(Classes.SilentHitPart.Value == "随机" and R6BodyParts[math.random(1,#R6BodyParts)] or Classes.SilentHitPart.Value)
                ...
                elseif Classes.ClosestType.Value == "最近箭矢" or Classes.ClosestType.Value == "仅重定向到目标" then
                    if Player then
                        local HitPart = Player:FindFirstChild(Classes.SilentHitPart.Value == "随机" and R6BodyParts[math.random(1,#R6BodyParts)] or Classes.SilentHitPart.Value)
                        if HitPart and (HitPart.Position - pos).Magnitude <= Classes.SilentAimRange.Value then
                            local Vel = (HitPart.Position - pos).Unit * 3000
                            caster:SetVelocity(Vel)
                        end
...
do --// Combat Modifications
    ...
    local function OnNewCharacter(Character)
        ...
        table.insert(Connections, Character.ChildAdded:Connect(function(Tool)
            if Classes.HitEffect.Value ~= "无" and Tool:IsA("Tool") and not table.find(Cache, Tool) then
...
do --// Parry Things
    function Parry(metadata)
        ...
        if Classes.APType.Value == "狂暴" then
    ...
    local playSoundOld = Modules.Name["SoundHandler"].playSound; Modules.Name["SoundHandler"].playSound = function(sound)
		if Classes.AutoParry.Value and Classes.APCheck.Value == "声音" and typeof(sound.parent) == "Instance" and sound.parent and sound.parent.Parent and sound.parent.Parent.Parent and sound.parent.Parent.Parent.Parent and sound.parent.Name:match("Hitbox") and sound.parent:FindFirstAncestorOfClass("Tool") then
            local Weapon, Metadata = Framework:GetWeapon()
    ...
    Framework:BindToRenderStep(LPH_JIT_MAX(function() -- I took this from my Balthazar script lol
        ...
        if Classes.APCheck.Value == "声音" then return end
...
TextChatService.TextChannels.RBXGeneral:DisplaySystemMessage("<font size='18' color='rgb(100, 83, 255)'><stroke color='#000000' thickness='1'><b>Atomic</b></stroke></font> <font size='16'>loaded successfully</font>")
